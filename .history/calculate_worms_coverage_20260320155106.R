...
worms_species <- read_tsv("worms-species.tsv", show_col_types = FALSE)
...
candidates <- read_tsv("gbif_candidates.tsv", show_col_types = FALSE)
...
# Save to TSV
output_file <- "percentage_worms.tsv"
